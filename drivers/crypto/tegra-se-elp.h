...
#define PKA1_TRNG_CMD_NOP		0
#define PKA1_TRNG_CMD_GEN_RAN_NUM	1
#define PKA1_TRNG_CMD_RAN_RESEED	2
#define PKA1_TRNG_CMD_NONCE_RESEED	3
...
#define TEGRA_SE_PKA1_TRNG_SMODE_MAX_REJECTS_SHIFT		16
#define TEGRA_SE_PKA1_TRNG_SMODE_MAX_REJECTS(x)	\
			(x << TEGRA_SE_PKA1_TRNG_SMODE_MAX_REJECTS_SHIFT)
...
#define TRNG_LAST_RESEED_I_RESEED				4
